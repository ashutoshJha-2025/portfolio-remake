    ...
    return (
        <>
            <div id="home-screen" className="w-screen h-screen relative">
                ...
                <div className="w-75 flex flex-col gap-5 absolute sm:top-[45%] left-[4%]  max-lg:hidden max-sm:block max-sm:bottom-35">
                ...
                <div className="absolute sm:top-[55%] right-0 mr-7 max-md:mr-15 max-sm:bottom-20 max-sm:flex max-sm:flex-col max-sm:items-center">
