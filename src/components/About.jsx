    ...
    return (
        <>
            <div id="about" className="h-screen w-screen bg-cover bg-center bg-no-repeat rounded-4xl shadow-[0_-10px_30px_0_rgba(17,17,17,0.9)] relative" style={{ backgroundImage: `url(${background_image})` }}>
                ...
                <p className="text-white mx-4 lg:p-4 absolute sm:top-35 font-normal lg:text-lg md:text-md md:p-0 max-sm:font-extralight max-sm:top-15 max-sm:text-sm max-sm:wrap">
                    Hello! I'm Ashutosh Jha, a Computer Science & Engineering (Cyber Security) student at Thakur College, Mumbai University. I am passionate about web development, problem solving, and building impactful digital experiences. Recently completed the MERN Stack, I enjoy developing responsive and scalable web applications using modern technologies. I have a strong foundation in Java, Data Structures & Algorithms, and have solved numerous coding problems on platforms like LeetCode to strengthen my analytical and problem solving abilities.
                </p>
                ...
                <div className="absolute bottom-0 flex sm:justify-around items-center left-1/2 -translate-x-1/2 h-75 w-[95%] sm:mx-4 max-sm:flex-col max-sm:bottom-20 max-sm:p-2 max-sm:gap-4">
                    ...
                    <div className="bg-[#ffffff0d] rounded-4xl h-55 lg:w-125 border border-[#3a3939] backdrop-blur-md md:w-90 max-sm:w-80 max-sm:h-35 max-sm:rounded-2xl">
                        ...
                        <ul className="text-[#dbdbdb] text-xl sm:mt-2.5 sm:ml-12.5 font-extralight list-disc list-outside max-sm:text-sm max-sm:ml-10">
                            ...
                            <li>Cyber Security & System Design</li>
                        </ul>
                    </div>
                    ...
                    <div className="bg-[#ffffff0d] rounded-4xl h-62.5 lg:w-150 border border-[#3a3939] backdrop-blur-md md:w-100 max-sm:w-80 max-sm:h-55 max-sm:rounded-2xl">
                        ...
                        <div className="border-0 border-t-2 border-t-[rgb(58,57,57)] my-2.5 mx-7.5 max-sm:my-0.5"></div>
                        <ul className="text-[#dbdbdb] text-xl sm:mt-2.5 sm:ml-12.5 font-extralight list-disc list-outside max-sm:text-sm max-sm:ml-10">
                            <li>Build impactful real world applications</li>
                            <li>Participate in hackathons and coding competitions</li>
                            <li>Improve problem solving and DSA skills</li>
                            <li>Become a well rounded engineer who builds and defends systems</li>
                        </ul>
                    </div>
                </div>
            </div >
